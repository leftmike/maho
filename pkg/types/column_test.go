...
func TestColumnType(t *testing.T) {
	cases := []struct {
		...
		{types.ColumnType{Type: types.BooleanType}, "BOOL", false},
		{types.ColumnType{Type: types.BooleanType, Size: 10}, "BOOL", false},
		{types.ColumnType{Type: types.BooleanType, Fixed: true}, "BOOL", false},
		...
		{types.ColumnType{Type: types.FloatType}, "DOUBLE", false},
		{types.ColumnType{Type: types.FloatType, Size: 10}, "DOUBLE", false},
		{types.ColumnType{Type: types.FloatType, Fixed: true}, "DOUBLE", false},
		{types.ColumnType{Type: types.IntegerType, Size: 2}, "SMALLINT", false},
		{types.ColumnType{Type: types.IntegerType, Size: 4}, "INT", false},
		{types.ColumnType{Type: types.IntegerType, Size: 8}, "BIGINT", false},
		{types.ColumnType{Type: types.IntegerType, Size: 2, Fixed: true}, "SMALLINT", false},
		{types.ColumnType{Type: types.IntegerType, Size: 1}, "", true},
